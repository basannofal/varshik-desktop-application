...
const AddPayment = () => {
  ...
  const savedata = async (e) => {
    ...
    if(team.paymentDate === '' || team.rollNo <= 0 || isNaN(team.paymentAmount)  || team.paymentAmount.trim() === ''){
      ...
      <section class="dashboard">
          ...
          <div>
            ...
            <div className="sfdropdown">
              {memberList
                ...
                .map((item) => (
                  <div
                    onClick={() => onSearch(`${item.f_name} ${item.m_name} ${item.l_name}`, item.roll_no)}
        ...
        <div class="dash-content   mt-5" >
          <div class="card">
            ...
            <form class="form">
              <div class="group ">
                <input className='mb-2' minLength={0} placeholder="" type="number" value={rollNo} onChange={(e) => {checkMember(e.target.value)}} required />
